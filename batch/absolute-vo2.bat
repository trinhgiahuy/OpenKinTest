...
echo _____new6 !tmp_hours! !tmp_mins! !tmp_secs!
...
if !new_mins! geq 60 (
echo ---------set60mins
echo ---beforeadd !new_hours! !new_mins! !new_secs!
set /A new_hours = !new_hours!+1
set /A new_mins = !new_mins!-60
echo ---afteradd !new_hours! !new_mins! !new_secs!
)
