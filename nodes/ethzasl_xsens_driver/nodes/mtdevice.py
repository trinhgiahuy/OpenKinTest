...
class MTDevice(object):
	...
	## Reset the orientation of the IMU
	def ResetOrientation(self, mode):
		"""Reset the orientation"""
		H, L = (mode&0xFF00)>>8, mode&0x00FF
		self.write_ack(MID.ResetOrientation, (H, L))
...
#		self.GoToMeasurement()
		...
		# Reset orientation
		# Heading reset
		self.ResetOrientation(0x0001)
		# Align reset
		self.ResetOrientation(0x0004)

		# Save orientation
		self.GoToConfig()
		self.ResetOrientation(0x0000)
		self.GoToMeasurement()
